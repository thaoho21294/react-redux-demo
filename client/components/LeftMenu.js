...
function LeftMenu() {
  ...
  return (
    <ListGroup>
      ...
      <ListGroup.Item action onClick={openTodayTask}>Today</ListGroup.Item>
      <ListGroup.Item action onClick={openTomorrowTask}>Tomorow</ListGroup.Item>
      <ListGroup.Item action onClick={openThisWeekTask}>This week</ListGroup.Item>
