...
export default function MainView() {
  ...
  switch (view) {
    case VIEW_TYPE.ALL_TASK:
      return <AllTasks />
    case VIEW_TYPE.COMPLETED_TASK:
      return <CompletedTaskView />
    case VIEW_TYPE.TODO_TASK:
      return <TodoTasksView />
    case VIEW_TYPE.TODAY_TASK:
      return <TasksView tasks={todayTasks} />
    case VIEW_TYPE.TOMORROW_TASK:
      return <TasksView tasks={tomorrowTasks} />
    case VIEW_TYPE.THIS_WEEK_TASK:
      return <ThisWeekTasksView />
    default:
      return ''
  }
}
